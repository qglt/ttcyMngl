...
-(void)setBaseCondition
{
    ...
    UIImageView * bgImage = [[UIImageView alloc]initWithImage:[Utils createImageWithColor:CENT_COLOR]];
...
{
    NSString * str = @"ᠬᠣᠭᠣᠰᠣᠨ ᠬᠣᠭᠣᠰᠣᠨ  ᠬᠣᠭᠣᠰᠣᠨ  ᠬᠣᠭᠣᠰᠣᠨ ";
    ...
    _emptyLabel.center = CGPointMake(self.center.x, self.bounds.size.height/2.5f);
...
//        NSData * data = [NSData dataWithContentsOfFile:lrcFileName];
