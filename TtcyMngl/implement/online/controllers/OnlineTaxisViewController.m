...
@interface OnlineTaxisViewController ()

@end

@implementation OnlineTaxisViewController
...
-(void)loadMore
{
    ...
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        ...
        NSArray *array = [CommonClass getJosnNSArrayUrl:[NSString stringWithFormat:@"/iosSeve.ashx?type=%d&&pagesize=%d&&pageCount=%d&&ctype=%d",typeid,PageSize,self.pageCount,2]  sid:@"Model"];
        //通知主线程刷新
